                    ...
                    <div class="card strpied-tabled-with-hover">
                        <div class="card-header ">
                            ...
                            <button type="button" onclick="shortcutTambah()" class="btn btn-success btn-fill btn-wd ml-2"
                                data-toggle="modal" data-target="#modalTambah">Tambah Kasir (F2)</button>
                        </div>
                        <div class="card-body table-full-width table-responsive">
                            <div class="col-lg-12">
                                <input type="text" class="form-control" id="searchInput" placeholder="Search...">
                            </div>
                            <table class="table table-hover table-striped" id="daftar_kasir">
                                <thead>
                                    <th>ID</th>
                                    <th>Nama Lengkap</th>
                                    <th>Username</th>
                                            ...
                                            <div class="modal-header justify-content-center">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <input class="form-control input-modal" id="nama_lengkap"
                                                            name="nama_lengkap" type="text"
                                                            placeholder="Nama Lengkap...">
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <label for="username">Username</label>
                                                        <input class="form-control input-modal" id="username"
                                                            name="username" type="text" placeholder="Username..">
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <label for="password">Password</label>
                                                        <input class="form-control input-modal" id="password"
                                                            name="password" type="password" placeholder="Password..">
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <label for="role">Role</label>
                                                        <select class="form-control input-modal" id="role"
                                                            name="role" type="text">
                            ...
                            <div class="modal fade modal-mini modal-primary" id="modalEdit" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="/edit_kasir" method="post">
                                            @csrf
                                            @method('post')
                                            <div class="modal-header justify-content-center">
                                                <input class="form-control" id="id_kasir_edit" name="id_kasir_edit"
                                                    type="hidden">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <label for="edit_nama_lengkap">Nama Lengkap</label>
                                                        <input class="form-control input-modal" id="edit_nama_lengkap"
                                                            name="edit_nama_lengkap" type="text"
                                                            placeholder="Nama Lengkap...">
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <label for="edit_username">Username</label>
                                                        <input class="form-control input-modal" id="edit_username"
                                                            name="edit_username" type="text"
                                                            placeholder="Username...">
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <label for="edit_role">Posisi</label>
                                                        <select class="form-control input-modal" id="edit_role"
                                                            name="edit_role" type="text">
                                                            <option value="admin">Admin</option>
                                                            <option value="kasir">Kasir</option>
                                                        </select>
                                                    </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="/hapus_kasir" method="post">
                                                @csrf
                                                @method('post')
                                                <input class="form-control" id="id_kasir_hapus" name="id_kasir_hapus"
                                                    type="hidden">
