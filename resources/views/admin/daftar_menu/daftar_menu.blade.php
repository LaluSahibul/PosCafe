                                ...
                                <tbody>
                                    @foreach ($menus as $menu)
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" onclick="editMenu({{ $menu->id }})"
                                            ...
                                            <div class="modal-header justify-content-center">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <input class="form-control input-modal" id="nama_menu"
                                                            name="nama_menu" type="text" placeholder="Nama Menu...">
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <label for="kategori_menu">Kategori Menu</label>
                                                        <select class="form-control input-modal" id="kategori_menu"
                                                            name="kategori_menu" type="text">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <select class="form-control input-modal" id="status"
